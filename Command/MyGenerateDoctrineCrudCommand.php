...
namespace Edlcdmc\Bundle\GeneratorBundle\Command;

use Edlcdmc\Bundle\GeneratorBundle\Generator\MyDoctrineCrudGenerator;
 ...
 */
class MyGenerateDoctrineCrudCommand extends GenerateDoctrineCommand
{
    private $generator;
...
//            ->setAliases(array('generate:doctrine:crud'))
    ...
    {
        $dialog = $this->getDialogHelper();
        $dialog->writeSection($output, 'Welcome to the Doctrine2 KAMMAG CRUD generator');
